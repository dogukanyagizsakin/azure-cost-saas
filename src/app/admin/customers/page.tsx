...
const navItems = [
  ...
  { href: '/admin/bulk', label: 'Toplu İşlemler', color: 'text-orange-400', bg: 'bg-orange-500/10', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          ...
          {navItems.map(item => (
            ...
            >
              ...
              {item.href === '/admin/customers' && customers.length > 0 && (
