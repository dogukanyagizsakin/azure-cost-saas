    ...
    <div className="min-h-screen flex relative">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-sm">
          ...
          <p className="text-gray-500 text-xs font-medium tracking-widest uppercase mb-8">COST PILOT</p>
      ...
      <div className="w-full lg:w-1/2 bg-gray-950 flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          {/* Email/Şifre Girişi — Ana giriş formu */}
          <form onSubmit={handleEmailLogin} className="space-y-3 mb-6">
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-semibold py-3.5 rounded-xl text-sm transition-colors flex items-center justify-center gap-2 mt-2"
            >
              {emailLoading ? (
          ...
          <div className="my-4 flex items-center gap-3">
            ...
            <span className="text-gray-600 text-xs">veya şununla devam et</span>
            <div className="flex-1 h-px bg-gray-800" />
          </div>

          {/* Microsoft ve Google — küçük butonlar */}
          <div className="grid grid-cols-2 gap-3">
            <button
              onClick={handleMicrosoftLogin}
              disabled={loading}
              className="flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 border border-gray-800 hover:border-gray-700 disabled:opacity-50 text-gray-300 hover:text-white text-xs font-medium rounded-xl py-2.5 transition-all"
            >
          ...
          <p className="text-center text-gray-700 text-xs mt-6">© 2025 UnifyTech · Tüm hakları saklıdır</p>
        </div>
      </div>
